...
<title>Customer Management View</title>
...
<?php
	...
	// storing the data returned in the $result variable
		...
		$select = "select * from `employee-customer` order by `EmployeeName` asc";
