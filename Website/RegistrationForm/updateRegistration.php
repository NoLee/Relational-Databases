...
<title>Update A Registration</title>
...
<body id="main_body" >
	...
	<div id="form_container">
		...
		<h1><a>Update A Registrationt</a></h1>
		<form id="form_982670" class="appnitro"  method="post" action="updateRegistration.php">
					<div class="form_description">
					<a href=../template.html> <img src="../home.png" alt="Home" id="home_img"> </a>  
			<h2>Update A Registration</h2>
			<p>Please insert the name of the customer that his/her registration will be updated, and then select the correct one.</p>
		</div>						
			<ul >
...
<?php
	...
	if (isset($_POST['submit'])){	
		...
		$select = "SELECT r.Customer_ID, r.Employee_ID,c.Name as CustomerName, c.Surname as CustomerSurname, r.`Registration Date`
		...
		if (mysqli_num_rows($result) > 0) {
		    ...
		    echo '	</br><li id="li_3" >
				...
				<form class="appnitro"  method="post" action="updateRegistrationForm.php">
				<span>
