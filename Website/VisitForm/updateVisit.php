...
<body id="main_body" >
	...
	<div id="form_container">
		...
		<form id="form_982670" class="appnitro"  method="post" action="updateVisit.php">
					<div class="form_description">
					<a href=../template.html> <img src="../home.png" alt="Home" id="home_img"> </a>  
			<h2>Update A visit</h2>
			<p>Please insert the name of the customer that his/her visit needs to be updated, and then select the correct one.</p>
		</div>						
			<ul >
...
<?php
	...
	if (isset($_POST['submit'])){	
		...
		if (mysqli_num_rows($result) > 0) {
		    ...
		    /*		    echo " </tr> </table> </li>";
		    echo '	</br><li id="li_3" >
				<label class="description" for="ID_to_update">Insert Employee ID to update (from the above results)</label>
				</li>
				<form class="appnitro"  method="post" action="updateEmployeeForm.php">
		    ...
		    echo " </tr> </table> </li>";
		    echo '	</br><li id="li_3" >
				<label class="description" for="CID_to_update">Insert Customer ID & Estate ID to update (from the above results)</label>	
				<form class="appnitro"  method="post" action="updateVisitForm.php">
				<span>
					<input id="CID_to_update" name= "CID_to_update" class="element text" maxlength="255" size="8" value=""/>
					<label>Customer ID</label>
				</span>
				<span>
					<input id="EID_to_update" name= "EID_to_update" class="element text" maxlength="255" size="14" value=""/>
