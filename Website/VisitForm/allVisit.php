...
<?php
	...
	// storing the data returned in the $result variable
		...
		$select = "SELECT  c.Name as CustomerName, c.Surname as CustomerSurname, e.Street as EstateStreet, e.`Street Num` as EstateStreetNum, v.`Visit Date`
			FROM `visit` as v
