...
<body id="main_body" >
	...
	<div id="form_container">
		...
		<form id="form_981137" class="appnitro"  method="post" action="">
			...
			<h2>Contract</h2>
			<p>Give The Necessary Information Below</p>
		</div>						
			<ul >
...
<?php
	...
	if (isset($_POST['submit'])){	
		...
		//FOR FIELDS THAT NEEDED NOT TO BE NULL
		$result1 = mysqli_query($con,"INSERT INTO `ideal home`.`contract` 
		(`Starts`,
		 `Duration`, 
		 `Rent`, 
		 `Payment Method`,
		...
		VALUES ('$year.$month.$day', ".$_POST["element_2"].", ".$_POST["element_3"].", ".$_POST["element_6"].",".$_POST["element_4"].",".$_POST["element_5"].");");
		...
		else { echo '<h3 class="correct"> Contract successfully added. <p></p> </h3>'; }
 ...
 ?>
		...
		<span>
			<input id="element_6_1" name="element_6" class="element radio" type="radio" value="Cash" />
<label class="choice" for="element_6_1">Cash</label>
<input id="element_6_2" name="element_6" class="element radio" type="radio" value="Check" />
<label class="choice" for="element_6_2">Check</label>
<input id="element_6_3" name="element_6" class="element radio" type="radio" value="Bank Deposit" />
