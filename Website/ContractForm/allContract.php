...
<?php
	...
	// storing the data returned in the $result variable
		...
		$select = "SELECT  w.Name as CustomerName, w.Surname as CustomerSurname, e.Street as EstateStreet, e.`Street Num` as EstateStreetNum, c.Starts, c.Duration, c.Rent, c.`Payment Method` 
			FROM `contract` as c
