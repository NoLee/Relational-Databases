...
<body id="main_body" >
	...
	<div id="form_container">
		...
		<form id="form_982670" class="appnitro"  method="post" action="updateContract.php">
...
<?php
	...
	if (isset($_POST['submit'])){	
		...
		if (mysqli_num_rows($result) > 0) {
		    ...
		    echo " </tr> </table> </li>";
		    echo '	</br><li id="li_3" >
				<label class="description" for="ID_to_update">Insert Contract ID to update (from the above results)</label>
				</li>
				<form class="appnitro"  method="post" action="updateContractForm.php">
