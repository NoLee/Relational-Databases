...
<body id="main_body" >
	...
	<div id="form_container">
		...
		<h1><a>Estate</a></h1>
		<form id="form_981137" class="appnitro"  method="post" action="addEstate.php">
...
<?php
	...
	if (isset($_POST['submit'])){	
		...
		//FOR FIELDS THAT NEEDED NOT TO BE NULL
		$result1 = mysqli_query($con,"INSERT INTO `ideal home`.`estate` 
		(
		`Street`, 
		`Street Num`, 
		`Postal Code`, 
		...
		`Employee_ID`, 
		`Owner_ID`) 
		VALUES (".$_POST["element_1"].", ".$_POST["element_2"].", ".$_POST["element_3"].", ".$_POST["element_4"].", ".$_POST["element_5"].", ".$_POST["element_6"].", ".$_POST["element_7"].", ".$_POST["element_8"].", ".$_POST["element_9"].");");
		...
		else { echo '<h3 class="correct"> Estate successfully added. <p></p> </h3>'; }
