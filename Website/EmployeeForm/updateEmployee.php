...
<body id="main_body" >
	...
	<div id="form_container">
		...
		<form id="form_982670" class="appnitro"  method="post" action="updateEmployee.php">
					<div class="form_description">
					<a href=../template.html> <img src="../home.png" alt="Home" id="home_img"> </a>  
			<h2>Update Employee</h2>
			<p>Please insert the name of the employee, and then select the correct one to update.</p>
