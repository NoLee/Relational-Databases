...
<?php
	...
	// storing the data returned in the $result variable
		...
		$select =$select = "SELECT  e1.Name, e1.Surname, e2.Name as `Supervisor Name`, e2.Surname as `Supervisor Surname`, e1.Street, e1.`Street Num`, e1.`Postal Code`, e1.Salary, e1.Sex, e1.`E-mail`, e1.Telephone
				FROM `employee` as e1
