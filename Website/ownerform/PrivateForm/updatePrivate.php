...
<body id="main_body" >
	...
	<div id="form_container">
		...
		<form id="form_982670" class="appnitro"  method="post" action="updatePrivate.php">
					<div class="form_description">
					<a href=../../template.html> <img src="../../home.png" alt="Home" id="home_img"> </a>  
			<h2>Update Private Owner</h2>
			<p>Please insert the name of the owner, and then select the correct one to update.</p>
	...
	if (isset($_POST['submit'])){	
		...
		if (mysqli_num_rows($result) > 0) {
		    ...
		    echo '	</br><li id="li_3" >
				...
				<form class="appnitro"  method="post" action="updatePrivateForm.php">
