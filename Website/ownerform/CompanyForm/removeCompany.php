...
<body id="main_body" >
	...
	<div id="form_container">
		...
		<h1><a>Remove Company</a></h1>
		<form id="form_982670" class="appnitro"  method="post" action="removeCompany.php">
					<div class="form_description">
					<a href=../../template.html> <img src="../../home.png" alt="Home" id="home_img"> </a>  
			<h2>Remove Company</h2>
			<p>Please insert the name of the Company, and then select the correct one.</p>
		</div>						
			<ul >
...
<?php
	...
	if (isset($_POST['submit'])){	
		...
		$select = "SELECT c.Owner_ID, c.`Company Name`, c.`Company Type`, o.Street, o.`Street Num`, o.`Postal Code`, o.`E-Mail`, o.Telephone, o.`Tax Registration Number`
			FROM `company` as c
			INNER JOIN `owner` as o
			ON c.Owner_ID=o.Owner_ID 
			WHERE `Company Name` LIKE '".$_POST["element_1_2"]."'";
	...
	if (isset($_POST['delete_button'])){	
		...
		if (mysqli_affected_rows($con)>0){
			...
			echo '<h3 class="wrong"> No company with such ID </h3>';
		}
	}
?>	
	</ul>
