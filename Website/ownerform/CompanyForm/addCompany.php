...
<body id="main_body" >
	...
	<div id="form_container">
		...
		<h1><a>Company</a></h1>
		<form id="form_981137" class="appnitro"  method="post" action="addCompany.php">
					<div class="form_description">
					<a href=../../template.html> <img src="../../home.png" alt="Home" id="home_img"> </a>  
			<h2>Company</h2>
			<p>Give The Necessary Information For The Company That Manages The Estate</p>
		</div>						
			<ul >
...
if (isset($_POST['submit'])){
		...
		if ( empty(mysqli_error($con)) && empty($war)  ){
			$result3 = mysqli_query($con,"INSERT INTO `ideal home`.`company` (
			`Owner_ID` ,
			`Company Name` ,
			`Company Type`
			)
			VALUES (
			'".$x."', ".$_POST["element_1"].", ".$_POST["element_2"].");");
			$war =mysqli_get_Warnings($con) ;
			...
			else { echo '<h3 class="correct"> Company '.$_POST['element_1']. ' succesfully added. <p></p> </h3>'; }
		}
		else 
		{
