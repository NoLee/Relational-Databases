...
<title>All Serve Relations</title>
...
<?php
	...
	// storing the data returned in the $result variable
		...
		$select = "SELECT e.Name as EmployeeName, e.Surname as EmployeeSurname,  c.Name as CustomerName, c.Surname as CustomerSurname
			FROM `serves` as s
