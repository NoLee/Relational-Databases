...
<title>Update an Employee/Customer Relation</title>
...
<body id="main_body" >
	...
	<div id="form_container">
		...
		<h1><a>Update an Employee/Customer Relation</a></h1>
		<form id="form_982670" class="appnitro"  method="post" action="updateServe.php">
					<div class="form_description">
					<a href=../template.html> <img src="../home.png" alt="Home" id="home_img"> </a>  
			<h2>Update an Employee/Customer Relation</h2>
			<p>Please insert the name of the employee that is in the Employee/Customer relation about to be updated and then select the correct one.</p>
		</div>						
			<ul >
...
<?php
	...
	if (isset($_POST['submit'])){	
		...
		$select = "SELECT  s.Customer_ID,s.Employee_ID, e.Name as EmployeeName, e.Surname as EmployeeSurname,  c.Name as CustomerName, c.Surname as CustomerSurname
			FROM `serves` as s
		...
		if (mysqli_num_rows($result) > 0) {
		    ...
		    echo " </tr> </table> </li>";
		    echo '	</br><li id="li_3" >
				<label class="description" for="CID_to_update">Insert Customer ID & Employee ID to update (from the above results)</label>	
				<form class="appnitro"  method="post" action="updateServeForm.php">
				<span>
