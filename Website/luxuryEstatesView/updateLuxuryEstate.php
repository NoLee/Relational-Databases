...
<body id="main_body" >
	...
	<div id="form_container">
		...
		<h1><a>Update Luxury Estate</a></h1>
		<form id="form_982670" class="appnitro"  method="post" action="updateLuxuryEstate.php">
					<div class="form_description">
					<a href=../template.html> <img src="../home.png" alt="Home" id="home_img"> </a>  
			<h2>Update Luxury Estate</h2>
	...
	if (isset($_POST['submit'])){	
		...
		if (mysqli_num_rows($result) > 0) {
		    ...
		    echo '	</br><li id="li_3" >
				...
				<form class="appnitro"  method="post" action="updateLuxuryEstateForm.php">
