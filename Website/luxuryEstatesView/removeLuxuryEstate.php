...
<title>Remove Luxury Estate</title>
...
<body id="main_body" >
	...
	<div id="form_container">
		...
		<h1><a>Remove Luxury Estate</a></h1>
		<form id="form_982670" class="appnitro"  method="post" action="removeLuxuryEstate.php">
					<div class="form_description">
					<a href=../template.html> <img src="../home.png" alt="Home" id="home_img"> </a>  
			<h2>Remove Luxury Estate</h2>
			<p>Please insert the address of the Luxury Estate, and then select the correct one.</p>
		</div>						
			<ul >
...
<?php
	...
	if (isset($_POST['delete_button'])){	
		$result = mysqli_query($con, "DELETE FROM `ideal home`.`luxuryestates` WHERE `luxuryestates`.`Estate_ID` = ".$_POST["element_2"]);
		if (mysqli_affected_rows($con)>0){
			echo '<h3 class="correct"> Successfully deleted </h3>';
		}
		else {
			echo '<h3 class="wrong"> No luxury estate with such ID </h3>';
		}
	}
?>	
	</ul>
