...
<body id="main_body" >
	...
	<h1><a>Luxury Estates</a></h1>
		<form id="form_982670" class="appnitro"  method="post" action="">
					<div class="form_description">
					<a href=../template.html> <img src="../home.png" alt="Home" id="home_img"> </a>  
			<h2>A list with all the luxury estates of Ideal Home LTE.</h2>
		</div>	
		<a href="removeLuxuryEstate.php">Remove a Luxury Estate</a>  <br>
		<a href="updateLuxuryEstate.php">Change the info of a Luxury Estate</a>  <br>
...
<?php
	...
	// storing the data returned in the $result variable
		...
		$select = "select * from `luxuryestates`";
