...
<title>Employees Assisting A Number of Customers</title>
...
<body id="main_body" >
	...
	<div id="form_container">
		...
		<h1><a>Employees Assisting A Number of Customers</a></h1>
		<form id="form_982670" class="appnitro"  method="post" action="assistsGreaterThan.php">
					<div class="form_description">
					<a href=../template.html> <img src="../home.png" alt="Home" id="home_img"> </a>  
			<h2>Employees Assisting A Number of Customers</h2>
			<p>Return the employees that assist more than <input id="element_1_1" name= "element_1_1" class="element text" maxlength="255" size="10" value=""/> customers. (Blank equals 0)</p>
		</div>						
			<ul >
...
<?php
	...
	if (isset($_POST['submit'])){	
		...
		$select = "select e.Name, e.Surname, count(s.Customer_ID) as NumberOfCustomers
				from `serves` as s 
				right join `employee` as e
				on e.Employee_ID=s.Employee_ID
				group by  e.Name, e.Surname
				having NumberOfCustomers > ".$_POST["element_1_1"].""
				;
