...
<title>Employees/Estates Relation</title>
...
<?php
	...
	// storing the data returned in the $result variable
		...
		$select = "select em.Name, em.Surname, es.Street , es.`Street Num` , es.`Postal Code`
				from `employee`as em 
