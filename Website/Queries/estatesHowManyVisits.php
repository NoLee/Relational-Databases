...
<title>How Many Visits On Each Estate</title>
...
<?php
	...
	// storing the data returned in the $result variable
		...
		$select = "select e.Street,e.`Street Num`, count(v.`Visit Date`) as NumberOfVisits
				from `estate` as e
