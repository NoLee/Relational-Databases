...
<title>Estates from Privates</title>
...
<?php
	...
	// storing the data returned in the $result variable
		...
		$select = "select p.Name,p.Surname,count(e.Owner_ID) as NumberOfEstates
				from `owner` as o
