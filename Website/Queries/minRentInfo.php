...
<title>Minimum Rent Estate Info</title>
...
<?php
	...
	// storing the data returned in the $result variable
		...
		$select = "select e.`Monthly Rent`, e.Street, e.`Street Num`, e.`Postal Code`,e.`Estate Type`, e.`Room Num`, e.`Square Meters` 
					from `estate`as e
