...
<title>Total Money Spent On Salaries</title>
...
<?php
	...
	// storing the data returned in the $result variable
		...
		$select = "select coalesce(sum(`Salary`),0) as `SumSalary` from `employee` ";
