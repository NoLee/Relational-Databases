...
<title>Estates From Companies</title>
...
<?php
	...
	// storing the data returned in the $result variable
		...
		$select = "select c.`Company Name`,count(e.Owner_ID) as NumberOfEstates
				from `owner` as o
