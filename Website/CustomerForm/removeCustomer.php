...
<body id="main_body" >
	...
	<div id="form_container">
		...
		<h1><a>Remove Customer</a></h1>
		<form id="form_982670" class="appnitro"  method="post" action="removeCustomer.php">
					<div class="form_description">
					<a href=../template.html> <img src="../home.png" alt="Home" id="home_img"> </a>  
			<h2>Remove Customer</h2>
			<p>Please insert the name of the customer, and then select the correct one.</p>
		</div>						
			<ul >
...
<?php
	...
	if (isset($_POST['delete_button'])){	
		$result = mysqli_query($con, "DELETE FROM `ideal home`.`customer` WHERE `customer`.`Customer_ID` = ".$_POST["element_2"]);
